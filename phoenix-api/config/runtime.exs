...
if config_env() == :prod do
  ...
  # Optional API authentication for import endpoints
  # Set IMPORT_API_TOKEN environment variable to enable authentication
  if import_token = System.get_env("IMPORT_API_TOKEN") do
    config :api, ApiWeb.Plugs.ApiAuth, import_api_token: import_token
  end
